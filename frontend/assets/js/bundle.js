...
/***/ "./src/aula-exercicio01/form-control.ts":
/*!**********************************************!*\
  !*** ./src/aula-exercicio01/form-control.ts ***!
  \**********************************************/
...
var submitEventFn = function (event) {
    ...
    if (shouldSentForm(target))
        console.log('Formulario enviado');
};
form.addEventListener('submit', submitEventFn);
form.addEventListener('change', function () { return hideErrorMessage(form); });
...
/*!**************************************************!*\
  !*** ./src/aula-exercicio01/aula19-exercicio.ts ***!
  \**************************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/aula-exercicio01/form-control.ts");
function fun(arg1) {
    console.log(this);
    console.log(arg1);
}
